...
1. **Clasificar el/los atributo(s) de calidad implicados**, siguiendo estos sub-pasos en orden, sin saltarlos:
   ...
   4. **El criterio de selección es siempre evidencia textual, nunca potencial narrativo.** Nunca elegir un atributo porque permite construir un escenario más rico, específico o interesante de redactar — si dos atributos empatan en evidencia textual, se resuelve con el sub-paso 3, no favoreciendo al que da pie a la mejor historia.
