...
- **Si no aparece nada textual**, aplicar el método de la **regla 4**
  de `docs/conocimiento/reglas-y-heuristica.md` (Parte 2): recorrer el
...
- **Antes de cerrar cualquier candidato**, aplicar las reglas 1–3 de
  `reglas-y-heuristica.md` (Parte 2): descartarlo si en realidad es una
...
respuesta** — siguiendo `../../../shared/template-6-partes-sei.md`.
...
Aplicar `docs/conocimiento/reglas-y-heuristica.md` (Parte 1 — Al
...
`docs/conocimiento/reglas-y-heuristica.md` (Parte 2 — Al validar):
...
aparecen en `template-6-partes-sei.md`):
...
de `template-6-partes-sei.md` (ej. el de Cyber Monday o el de
Escalabilidad IoT).
...
- `../../../shared/template-6-partes-sei.md` — estructura y
...
- `docs/conocimiento/reglas-y-heuristica.md` — mecanismo de inferencia
  con asunción explícita (Parte 1, paso 3) y las 9 reglas de validación
  (Parte 2, pasos 1 y 4).

## Reglas de proceso

- `docs/conocimiento/reglas-y-heuristica.md`, Parte 2 — 9 reglas de
